...
from app.models import User, AnonymousUser, Role, Permission, Follow, Comment, Post
...
class UserModelTestCase(unittest.TestCase):
    ...
    def test_roles_and_permissions(self):
        ...
        u2 = User(email = 'john2@example.com', password = 'dog', confirmed =True)
    ...
    def test_user_gravatar(self):
        ...
        self.assertTrue(u.gravatar() == 'http://www.gravatar.com/avatar/50a1aad995d09ae00bb2d297d6019b57?s=100&d=identicon&r=g')
    ...
    def test_follows(self):
        ...
        f = u2.followers.filter_by(follower=u1).first()
